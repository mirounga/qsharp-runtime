...
TEST_CASE("Perf of injecting equal superposition state", "[micro_benchmark]")
{
    ...
    SECTION("Prepare the state with quantum operations")
    {
        ...
        std::cout << "Quantum state preparation:\t" << (std::chrono::high_resolution_clock::now() - start).count()
                  << std::endl;
    }
    ...
    SECTION("Inject total state")
    {
        ...
        auto start = std::chrono::high_resolution_clock::now();
        sim.InjectState(qs, amplitudes);
        std::cout << "    Total state injection:\t" << (std::chrono::high_resolution_clock::now() - start).count()
                  << std::endl;
    }
    ...
    SECTION("Inject partial state")
    {
        ...
        sim.InjectState(qs, amplitudes);
        sim.H(q_last);
        std::cout << "  Partial state injection:\t" << (std::chrono::high_resolution_clock::now() - start).count()
                  << std::endl;
...
TEST_CASE("Perf of injecting cat state", "[micro_benchmark]")
{
    ...
    SECTION("Prepare the state with quantum operations")
    {
        ...
        std::cout << "Quantum cat state preparation:\t" << (std::chrono::high_resolution_clock::now() - start).count()
                  << std::endl;
    }
    ...
    SECTION("Inject total state")
    {
        ...
        auto start = std::chrono::high_resolution_clock::now();
        sim.InjectState(qs, amplitudes);
        std::cout << "    Total cat state injection:\t" << (std::chrono::high_resolution_clock::now() - start).count()
                  << std::endl;
    }
    ...
    SECTION("Inject partial state")
    {
        ...
        sim.InjectState(qs, amplitudes);
        sim.CX({qs[0]}, q_last);
        std::cout << "  Partial cat state injection:\t" << (std::chrono::high_resolution_clock::now() - start).count()
                  << std::endl;
