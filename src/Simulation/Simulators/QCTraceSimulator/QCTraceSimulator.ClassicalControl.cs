...
namespace Microsoft.Quantum.Simulation.Simulators.QCTraceSimulators.Implementation
{
    public partial class QCTraceSimulatorImpl
    {
        ...
        public class TracerApplyIfElse : QuantumProcessor.Extensions.ApplyIfElseIntrinsic
        {
        ...
        public class TracerApplyIfElseA : QuantumProcessor.Extensions.ApplyIfElseIntrinsicA
        {
            private QCTraceSimulatorImpl tracerCore { get; }
        ...
        public class TracerApplyIfElseC : QuantumProcessor.Extensions.ApplyIfElseIntrinsicC
        {
            private QCTraceSimulatorImpl tracerCore { get; }
        ...
        public class TracerApplyIfElseCA : QuantumProcessor.Extensions.ApplyIfElseIntrinsicCA
        {
            private QCTraceSimulatorImpl tracerCore { get; }
        ...
        public class TracerApplyConditionally : QuantumProcessor.Extensions.ApplyConditionallyIntrinsic
        {
            private QCTraceSimulatorImpl tracerCore { get; }
        ...
        public class TracerApplyConditionallyA : QuantumProcessor.Extensions.ApplyConditionallyIntrinsicA
        {
            private QCTraceSimulatorImpl tracerCore { get; }
        ...
        public class TracerApplyConditionallyC : QuantumProcessor.Extensions.ApplyConditionallyIntrinsicC
        {
            private QCTraceSimulatorImpl tracerCore { get; }
        ...
        public class TracerApplyConditionallyCA : QuantumProcessor.Extensions.ApplyConditionallyIntrinsicCA
        {
            private QCTraceSimulatorImpl tracerCore { get; }
